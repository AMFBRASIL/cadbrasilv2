    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/compras-gov-br", changefreq: "weekly", priority: "0.98" },
          { path: "/certificado-digital-sicaf", changefreq: "weekly", priority: "0.98" },
          { path: "/sicaf-irregular", changefreq: "weekly", priority: "0.98" },
          { path: "/quanto-custa-sicaf", changefreq: "weekly", priority: "0.98" },
          { path: "/sicaf-mei", changefreq: "weekly", priority: "0.97" },
          ...
          { path: "/como-cadastrar-empresa-sicaf", changefreq: "weekly", priority: "0.97" },
          ...
          { path: "/acesso-remoto", changefreq: "weekly", priority: "0.92" },
