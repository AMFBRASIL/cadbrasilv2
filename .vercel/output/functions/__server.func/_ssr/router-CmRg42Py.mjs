...
import { k as MessageCircle, F as FileCheckCorner, c as Bot, o as ShieldCheck, H as Headphones, p as Sparkles, a as ArrowRight, X, M as Menu } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-oi6Vj-6m.css";
...
const $$splitComponentImporter$6 = () => import("./o-que-e-sicaf-BpWyvNeh.mjs");
const ORIGIN$6 = "https://cadbrasil.com.br";
const Route$6 = createFileRoute("/o-que-e-sicaf")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./como-funciona-BdsXRJUa.mjs");
...
const $$splitComponentImporter$4 = () => import("./beneficios-yppi67Kt.mjs");
const ORIGIN$4 = "https://cadbrasil.com.br";
const Route$4 = createFileRoute("/beneficios")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./assistente-CcNbQQAi.mjs");
const ORIGIN$3 = "https://cadbrasil.com.br";
const Route$3 = createFileRoute("/assistente")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./index-DMtPBiGp.mjs");
...
const $$splitComponentImporter$1 = () => import("./faq.index-Bfif4tH8.mjs");
...
const $$splitComponentImporter = () => import("./faq._slug-DHgmycKD.mjs");
const $$splitNotFoundComponentImporter = () => import("./faq._slug-CYc-z0KV.mjs");
const ORIGIN = "https://cadbrasil.com.br";
const Route = createFileRoute("/faq/$slug")({
  loader: ({
    params
  }) => {
...
const OQueESicafRoute = Route$6.update({
  id: "/o-que-e-sicaf",
  path: "/o-que-e-sicaf",
  getParentRoute: () => Route$8
});
...
const BeneficiosRoute = Route$4.update({
  id: "/beneficios",
  path: "/beneficios",
  getParentRoute: () => Route$8
});
const AssistenteRoute = Route$3.update({
  id: "/assistente",
  path: "/assistente",
  getParentRoute: () => Route$8
});
...
const FaqIndexRoute = Route$1.update({
  id: "/faq/",
  path: "/faq/",
  getParentRoute: () => Route$8
});
const FaqSlugRoute = Route.update({
  id: "/faq/$slug",
  path: "/faq/$slug",
  getParentRoute: () => Route$8
});
