...
import { c as PageShell, P as PageHero, C as CADASTRO_URL, m as miniFaq, I as InlineCta } from "./router-apgsbpvz.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { g as CircleCheck, L as Landmark, f as Building2, m as Gavel, S as Scale, k as FileText, J as TriangleAlert, a as ArrowRight } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-3xl px-4 py-12 prose prose-lg prose-neutral", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-2xl border border-brand/30 bg-brand/5 p-6 not-prose", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-muted-foreground text-base", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/guia/cadastro-sicaf-passo-passo", className: "text-brand font-medium underline underline-offset-4", children: "Cadastro SICAF passo a passo 2026" }),
          "."
        ] })
      ] })
    ] }),
