...
import { C as CADASTRO_URL, W as WhatsAppLink, p as getDefaultIntent, a as ContactSection, b as FloatingCta } from "./router-BXLSSgYo.mjs";
import { a as ArrowRight, v as MessageCircle, h as CircleCheck, i as CircleQuestionMark, m as FileText } from "../_libs/lucide-react.mjs";
const RELATED_LINKS = [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          className: "pt-[6.75rem] sm:pt-32 pb-2 mx-auto max-w-4xl px-4 text-sm text-[#0a4d2c]/70",
