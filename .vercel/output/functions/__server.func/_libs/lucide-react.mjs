...
const BadgeCheck = createLucideIcon("badge-check", __iconNode$B);
const __iconNode$A = [
...
const FolderSync = createLucideIcon("folder-sync", __iconNode$r);
const __iconNode$q = [
...
const Gavel = createLucideIcon("gavel", __iconNode$p);
const __iconNode$o = [
