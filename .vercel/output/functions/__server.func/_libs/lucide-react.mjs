...
const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$z);
const __iconNode$y = [
  [
    "path",
    {
...
const FileCheck = createLucideIcon("file-check", __iconNode$y);
const __iconNode$x = [
  [
    "path",
    {
...
const FolderSync = createLucideIcon("folder-sync", __iconNode$w);
const __iconNode$v = [
